...
mesh.x = np.delete(mesh.x, np.argwhere((mesh.x >= -92) & (mesh.x <= 92)))
mesh.x = np.concatenate((mesh.x, arangeWithEndpoint(-92,92,1)))
mesh.y = np.delete(mesh.y, np.argwhere((mesh.y >= -91.9714) & (mesh.y <= 91.9714)))
mesh.y = np.concatenate((mesh.y, arangeWithEndpoint(-91.9714,91.9714,1)))
mesh.z = np.delete(mesh.z, np.argwhere((mesh.z >= 5) & (mesh.z <= 156.4)))
mesh.z = np.concatenate((mesh.z, arangeWithEndpoint(5,156.4,1)))

## GRID - grid_0.1mm - Cylinder_midle (Fixed Distance)
mesh.x = np.delete(mesh.x, np.argwhere((mesh.x >= -92) & (mesh.x <= 92)))
mesh.x = np.concatenate((mesh.x, arangeWithEndpoint(-92,92,0.1)))
mesh.y = np.delete(mesh.y, np.argwhere((mesh.y >= -91.9714) & (mesh.y <= 91.9714)))
mesh.y = np.concatenate((mesh.y, arangeWithEndpoint(-91.9714,91.9714,0.1)))
...
mesh.y = np.delete(mesh.y, np.argwhere((mesh.y >= -91.9714) & (mesh.y <= 91.9714)))
mesh.y = np.concatenate((mesh.y, arangeWithEndpoint(-91.9714,91.9714,1)))
mesh.z = np.delete(mesh.z, np.argwhere((mesh.z >= -156.4) & (mesh.z <= -5)))
mesh.z = np.concatenate((mesh.z, arangeWithEndpoint(-156.4,-5,1)))
